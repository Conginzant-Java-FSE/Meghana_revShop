...
public class ProductDao {
    ...
    public List<Product> search(String key) {
        ...
        try (var con = DBConnection.getConnection();
            ...
            log.error("search failed key={}", key, e);
        }
    ...
    public List<Product> getProductsBySeller(int sellerId) {
        ...
        try (var con = DBConnection.getConnection();
            ...
            log.error("getProductsBySeller failed sellerId={}", sellerId, e);
        }
    ...
    public boolean addProduct(Product p) {
        ...
        try (var con = DBConnection.getConnection();
             var ps = con.prepareStatement("""
                 INSERT INTO product
                 (seller_id,category_id,product_name,description,mrp,
                  discounted_price,stock_quantity,stock_threshold)
                 VALUES(?,?,?,?,?,?,?,?)
             """)) {
            ...
            log.error("addProduct failed product={}", p.getProductName(), e);
        }
    ...
    public boolean updateProduct(int sellerId, Product p) {
        ...
        try (var con = DBConnection.getConnection();
         ...
         """)) {
            ...
            ps.setInt(7, p.getStockThreshold());
            ...
            log.error("updateProduct failed productId={} sellerId={}",
                    p.getProductId(), sellerId, e);
        }
    ...
    public boolean deleteProduct(int sellerId, int pid) {
        ...
        try (var con = DBConnection.getConnection();
            ...
            log.error("deleteProduct failed productId={} sellerId={}", pid, sellerId, e);
        }
    ...
    public List<Product> lowStock(int sellerId) {
        ...
        String sql = """
            ...
            FROM product
            WHERE seller_id=? AND stock_quantity<=stock_threshold
        """;
        ...
        try (var con = DBConnection.getConnection();
            ...
            log.info("lowStock fetched sellerId={} count={}", sellerId, list.size());

        } catch (Exception e) {
            log.error("lowStock failed sellerId={}", sellerId, e);
        }
    ...
    public boolean updateThreshold(int sellerId, int productId, int threshold) {
        ...
        try (var con = DBConnection.getConnection();
            ...
            log.error("updateThreshold failed productId={} sellerId={}",
    ...
    public List<Product> lowStockProducts(int sellerId) {
        ...
        try (var con = DBConnection.getConnection();
            ...
            log.info("lowStockProducts fetched sellerId={} count={}", sellerId, list.size());

        } catch (Exception e) {
            log.error("lowStockProducts failed sellerId={}", sellerId, e);
        }
